(function ()
{
    ...
    t = window.Morris =
    {
    }, e = jQuery, t.EventEmitter = function ()
    {
        function e()
        {
        }
        return e.prototype.on = function (e, t)
        {
            ...
            {
            }), this.handlers[e] == null && (this.handlers[e] = []), this.handlers[e].push(t)
    ...
    }, t.Grid = function (n)
    {
        function r(t)
        {
            ...
            this.el.css("position") === "static" && this.el.css("position", "relative"), this.options = e.extend(
                {
                }, this.gridDefaults, this.defaults || {
                }, t), typeof this.options.units == "string" && (this.options.postUnits = t.units), this.raphael = new Raphael(this.el[0]), this.elementWidth = null, this.elementHeight = null, this.dirty = !1, this.init && this.init(), this.setData(this.options.data), this.el.bind("mousemove", function (e)
            {
                var t;
        ...
        }, r.prototype.setData = function (e, n)
        {
            ...
            d = this.cumulative ? 0 : null, v = this.cumulative ? 0 : null, this.options.goals.length > 0 && (u = Math.min.apply(null, this.options.goals), o = Math.max.apply(null, this.options.goals), v = v != null ? Math.min(v, u) : u, d = d != null ? Math.max(d, o) : o), this.data = function ()
            {
                var n, r, o;
                o = [];
                for (s = n = 0, r = e.length; n < r; s = ++n) f = e[s], a =
                {
                }, a.label = f[this.options.xkey], this.options.parseTime ? (a.x = t.parseDate(a.label), this.options.dateFormat ? a.label = this.options.dateFormat(a.x) : typeof a.label == "number" && (a.label = (new Date(a.label)).toString())) : a.x = s, c = 0, a.y = function ()
                {
                    var e, t, n, r;
        ...
        {
            var e, t, n, r;
            n = this.el.width(), t = this.el.height();
            if (this.elementWidth !== n || this.elementHeight !== t || this.dirty)
            {
                this.elementWidth = n, this.elementHeight = t, this.dirty = !1, this.left = this.options.padding, this.right = this.elementWidth - this.options.padding, this.top = this.options.padding, this.bottom = this.elementHeight - this.options.padding, this.options.axes && (r = function ()
                {
                    var t, n, r, i;
                    r = this.grid, i = [];
                    for (t = 0, n = r.length; t < n; t++) e = r[t], i.push(this.measureText(this.yAxisFormat(e), this.options.gridTextSize).width);
                    return i
                }.call(this), this.left += Math.max.apply(Math, r), this.bottom -= 1.5 * this.options.gridTextSize), this.width = Math.max(1, this.right - this.left), this.height = Math.max(1, this.bottom - this.top), this.dx = this.width / (this.xmax - this.xmin), this.dy = this.height / (this.ymax - this.ymin);
    ...
    }, t.Hover = function ()
    {
        function n(n)
        {
            n == null && (n =
            {
                ...
                {
                }, t.Hover.defaults, n), this.el = e("<div class='" + this.options["class"] + "'></div>"), this.el.hide(), this.options.parent.append(this.el)
        }
        return n.defaults =
        {
    ...
    }(), t.Line = function (e)
    {
        ...
        }, n.createPath = function (e, n, r)
        {
            ...
            {
                i = e[u];
                if (i.y != null) if (c.y != null) n ? (s = o[u], f = o[u - 1], a = (i.x - c.x) / 4, h = c.x + a, d = Math.min(r, c.y + a * f), p = i.x - a, v = Math.min(r, i.y - a * s), l += "C" + h + "," + d + "," + p + "," + v + "," + i.x + "," + i.y) : l += "L" + i.x + "," + i.y;
    ...
    }(t.Grid), t.labelSeries = function (n, r, i, s, o)
    {
        ...
        p === void 0 && (p = t.LABEL_SPECS.second), o && (p = e.extend(
            {
            }, p, {
                fmt: o
            })), u = p.start(a), c = [];
    ...
    }, t.AUTO_LABEL_ORDER = ["decade", "year", "month", "day", "hour", "30min", "15min", "10min", "5min", "minute", "30sec", "15sec", "10sec", "5sec", "second"], t.Area = function (n)
    {
        function i(n)
        {
            ...
            s = e.extend(
                {
                }, r, n), this.cumulative = !s.behaveLikeLine, s.fillOpacity === "auto" && (s.fillOpacity = s.behaveLikeLine ? .8 : 1), i.__super__.constructor.call(this, s)
        }
        var r;
        return o(i, n), r =
        {
        ...
        {
            var t;
            return t = Raphael.rgb2hsl(this.colorFor(this.data[e], e, "line")), Raphael.hsl(t.h, Math.min(255, this.options.behaveLikeLine ? t.s * .9 : t.s * .75), Math.min(255, this.options.behaveLikeLine ? t.l * 1.2 : t.l * 1.25))
    ...
    }(t.Line), t.Bar = function (n)
    {
        function r(n)
        {
            ...
            r.__super__.constructor.call(this, e.extend(
                {
                }, n, {
                    parseTime: !1
                }))
    ...
    }(t.Grid), t.Donut = function (n)
    {
        function r(n)
        {
            ...
            typeof n.element == "string" ? this.el = e(document.getElementById(n.element)) : this.el = e(n.element), this.options = e.extend(
                {
                }, this.defaults, n);
        ...
        {
            var s;
            return s = this.raphael.text(e, t, "").attr("font-size", '12px').attr("fill", 'White'), i != null && s.attr("font-weight", '300'), s
        }, r
